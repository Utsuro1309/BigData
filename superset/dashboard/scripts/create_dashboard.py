...
client = SupersetAPIClient(host="http://172.18.5.1:8088")
...
database_id = client.create_database(
    ...
    engine="mysql",
    driver="mysqldb",
    sqlalchemy_uri="mysql://root:secret@172.18.5.2:3306/sales_db"
)
...
print("Superset configurations created successfully...")